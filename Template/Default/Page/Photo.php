...
<div class="pmb-block row">
	<div class="col-md-6" id="crop-avatar" style="border-right: 2px dashed #B9B9B9;">
		<div class="pmbb-header">
			<h2><i class="fa fa-cloud"></i> 上传自拍</h2>
			<small>自拍照将会展示在您的个人主页。</small>
		</div>
		<div class="avatar-view img-rounded img-thumbnail" title="上传自拍">
			<img src="<?=UserHead($UInfo['UserData']['Public']['Photo'])?>" alt="Avatar">
		</div>
		<div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<form class="avatar-form" action="<?=U('func','Image','Crop','Photo')?>" enctype="multipart/form-data" method="post">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
							<h4 class="modal-title" id="avatar-modal-label">上传自拍</h4>
						</div>
	...
	<div class="col-md-6" id="crop-avatar">
		<div class="pmbb-header">
			...
			<small>直接使用您的QQ头像作为自拍照片。</small>
		</div>
		<form action="<?=U('Page','Photo',$Type,'Save')?>" method="post" id="OptionFrom" class="form-horizontal">
...
<script>G_aspectRatio=2/3;</script>
